  ...
  render() {
    return (
      <div className="main">
        ...
        <h3 className="blue">Sign up information for decals can be found on the decal website. Information about Micromouse can be found <a className="link" href="https://decal.berkeley.edu/courses/106">here.</a> </h3>
        </div>
      </div>
    );
  }
